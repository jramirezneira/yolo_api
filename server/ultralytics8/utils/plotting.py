...
class Annotator:
    ...
    def count_labels(self, counts=0, count_txt_size=1, color=(255, 255, 255), txt_color=(0, 0, 0), reg_counts=None):
        ...
        # t_size_in = cv2.getTextSize(str(counts), 0, fontScale=font_scale, thickness=tf)[0]
        ...
        try:
            ...
            for index, stat in enumerate(counts):
                y = y0 + index*dy
                ps.putBText(self.im,stat,text_offset_x=text_x,text_offset_y=y,vspace=5,hspace=5, font_scale=font_scale,font=font, background_RGB=color, text_RGB=txt_color, alpha=0.3, thickness=thickness)
